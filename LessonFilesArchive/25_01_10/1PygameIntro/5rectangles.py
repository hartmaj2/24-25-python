...
background = pygame.image.load("25_01_10/graphics/Sky.png")
ground = pygame.image.load("25_01_10/graphics/ground.png")


player_surf = pygame.image.load("25_01_10/graphics/Player/player_stand.png")
