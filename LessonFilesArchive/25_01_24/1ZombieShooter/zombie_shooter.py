...
SCREEN_WIDTH = 800 * GAME_SCALE
SCREEN_HEIGHT = 600 * GAME_SCALE
...
PLAYER_IMAGE = pygame.image.load("25_01_24/1ZombieShooter/player.svg").convert_alpha()
...
class Player:
    ...
    def rotate(self,mouse_pos):
        ...
        self.image = pygame.transform.rotozoom(PLAYER_IMAGE,360 * self.rotation / (2 * math.pi),1)
        # self.image = pygame.transform.rotate(PLAYER_IMAGE,360 * self.rotation / (2 * math.pi)) // rotate distorts image when not rotated by increments of 90
...
ZOMBIE_IMAGE = pygame.image.load("25_01_24/1ZombieShooter/zombie.svg").convert_alpha()
ZOMBIE_SPEED = 1
...
class Zombie:
    ...
    def rotate(self,player_pos):
        ...
        self.image = pygame.transform.rotozoom(ZOMBIE_IMAGE,360 * self.rotation / (2 * math.pi),1)
